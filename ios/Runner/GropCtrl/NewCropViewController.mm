...
- (void)viewDidLoad {
    ...
    CGRect cropFrame = CGRectMake(_sourceImageView.contentFrame.origin.x+40,
                                  _sourceImageView.contentFrame.origin.y+64,
                                  _sourceImageView.contentFrame.size.width,
                                  _sourceImageView.contentFrame.size.height);
    _cropRect= [[MMCropView alloc] initWithFrame:cropFrame];
    //_cropRect.backgroundColor = [UIColor yellowColor];
...
-(void)initCropFrame{
    ...
    _sourceImageView = [[UIImageView alloc] initWithFrame:CGRectMake(40, 64, kScreenWidth-80, kScreenHeight-kCameraToolBarHeight-64)];
...
//        self.scrollView.frame=CGRectMake(0, 120, self.view.bounds.size.width, 64);
//    }];
...
-(void)buttonsScroll{
    ...
    self.scrollView=[[UIScrollView alloc] initWithFrame:CGRectMake(0, 120, self.view.bounds.size.width, 64)];
    ...
    [self.scrollView setContentSize:CGSizeMake(xCoord, yCoord)];
    self.scrollView.showsHorizontalScrollIndicator=NO;
    self.scrollView.backgroundColor=[UIColor colorWithHexString:backgroundHex];
}
...
-(void)scrolllButAction:(UIButton *)sender{
    switch (sender.tag) {
        ...
        case 5:
            ...
            _cropRect.hidden=NO;
            [UIView animateWithDuration:0.5 animations:^{
                self.scrollView.frame=CGRectMake(0, 124, self.view.bounds.size.width, 64);
...
- (IBAction)cropAction:(id)sender {
    ...
    [UIView transitionWithView:_sourceImageView duration:0.3 options:UIViewAnimationOptionTransitionCrossDissolve animations:^{
        ...
        //UIImage *newImage = MatToUIImage(undistorted);
